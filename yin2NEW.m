...
% defaults
if ~isfield(p, 'maxprd'); p.maxprd=133; end
if ~isfield(p, 'minprd'); p.minprd=20; end
if ~isfield(p, 'wsize'); p.wsize=p.maxprd; end
if ~isfield(p, 'hop'); p.hop = 80;  end%%p.hop=p.wsize; end
